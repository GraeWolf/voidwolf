...
need_pat "${ROOT}/bin/voidwolf-displays" 'restore_layout|restore\)' "displays has restore"
need_pat "${ROOT}/config/X11/.xinitrc" 'voidwolf-displays restore' "xinitrc restores displays"
need "${ROOT}/config/displays/examples/dual-left.sh.example"
