...
need_re "Super+Shift+P full screenshot" 'MODKEY\|ShiftMask,\s+XK_p,\s+spawn.*scrotfull|scrotfull'
need_re "Super+Shift+S region screenshot" 'MODKEY\|ShiftMask,\s+XK_s,\s+spawn.*scrotregion|scrotregion'
need_re "Print screenshot alias" 'XK_Print'
